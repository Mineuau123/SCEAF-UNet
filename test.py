...
from rwkv_unet import SCEAF_UNet
import ttach as tta
...
if __name__ == "__main__":
    ...
    args.exp = 'sceaf' + dataset_name + str(args.img_size)
    snapshot_path = "./outputs/{}/{}".format(args.exp, 'exp15')
    ...
    net = SCEAF_UNet(in_channels=1, img_size=args.img_size, num_classes=args.num_classes,pretrained_path=None).cuda()
    transforms = tta.Compose(
    [
        tta.HorizontalFlip(), 
        #tta.Rotate90(angles=[0, 90, 180, 270]), #for ACDC
    ]
)
